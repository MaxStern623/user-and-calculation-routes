...
def fastapi_server():
    ...
    # Use the same Python interpreter that's running the tests to launch uvicorn
    # This avoids picking up a system uvicorn that may not have the project's
    # dependencies installed (for example email-validator required by pydantic).
    import sys
